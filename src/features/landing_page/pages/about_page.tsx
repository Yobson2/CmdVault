      ...
      <section className='py-16'>
        <div className='container mx-auto px-4'>
          <div className='mx-auto max-w-4xl'>
            <h2 className='mb-6 text-center text-3xl font-bold'>Why CmdVault?</h2>
            <div className='prose prose-lg mx-auto max-w-none'>
              <p className='text-muted-foreground mb-4'>
                Every developer has been there: you solved a tricky problem
                with the perfect command, but a week later you can&apos;t
                remember what it was. You scroll through terminal history,
                search old Slack messages, or just figure it out again from
                scratch.
              </p>
              <p className='text-muted-foreground mb-4'>
                ...
                categories keep everything organized, and a powerful search
                puts any command at your fingertips.
              </p>
              <p className='text-muted-foreground'>
                But the real power is sharing. Make your best commands public
                for the community, or keep them within your team. Great
                commands deserve to be reused, not rediscovered.
              </p>
            </div>
          </div>
        </div>
