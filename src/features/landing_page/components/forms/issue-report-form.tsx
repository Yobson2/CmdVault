      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Please be as specific as possible to help us address the issue effectively
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., Student Center Room 204, Main Campus Building" {...field} />
              </FormControl>
              <FormDescription>
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-blue-50">
              ...
              <div className="space-y-1 leading-none">
                ...
                <FormDescription>
                  Check this if you prefer not to provide your contact information. Note: We won't be able to follow up with you directly.
                </FormDescription>
              </div>
            </FormItem>
          )}
        ...
        {!isAnonymous && (
          <div className="space-y-4 border-t pt-4">
            <h3 className="font-semibold text-sm text-muted-foreground">Contact Information (Optional)</h3>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    We'll use this to keep you updated on the status of your report
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
